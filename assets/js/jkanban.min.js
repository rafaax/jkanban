                        ...
                        function l(t) {
                            ...
                            if (e.options.itemHandleOptions.enabled) {
                                if (void 0 !== (e.options.itemHandleOptions.customHandler || void 0))
                                    return (n =
                                        "<div> " +
                                        e.options.itemHandleOptions.customHandler.replace(/%([^%]+)%/g, function (e, n) {
                        ...
                        arguments[0] &&
                                    ...
                                    window.innerWidth > e.options.responsive &&
                                        ...
                                        (e.drake = e
                                            ...
                                            .on("drop", function (t, n, o, i) {
                                                ...
                                                (void 0 !== r.dragTo && -1 === r.dragTo.indexOf(n.parentNode.dataset.id) && n.parentNode.dataset.id !== o.parentNode.dataset.id && e.drake.cancel(!0), null !== t) &&
                                                    (!1 === e.options.dropEl(t, n, o, i) && e.drake.cancel(!0), t.classList.remove("is-moving"), "function" == typeof t.dropfn && t.dropfn(t, n, o, i));
                                            })));
                            }),
                            ...
                            (this.addElement = function (t, n, o) {
                                ...
                                return (
                                    ...
                                    void 0 !== n.id && "" !== n.id && d.setAttribute("data-eid", n.id),
                                    n.class &&
                                    ...
                                    (d.innerHTML = l(n)),
                                    (d.clickfn = n.click),
                                    (d.contextfn = n.context),
                                    (d.dragfn = n.drag),
                                    (d.dragendfn = n.dragend),
                                    (d.dropfn = n.drop),
                                    s(d, n),
                                    r(d),
                                    a(d),
                                    ...
                                    n || e.options.boards.push(v),
                                        e.options.responsivePercentage ||
                                            ("" === e.container.style.width
                                                ...
                                                : (e.container.style.width = parseInt(e.container.style.width) + parseInt(o) + 2 * parseInt(e.options.gutter) + "px"));
                                ...
                                if (N)
                                    if (0 !== s(e)) {
                                        if (!(void 0 !== e.clientX && Math.abs(e.clientX - C) <= (A.slideFactorX || 0) && void 0 !== e.clientY && Math.abs(e.clientY - O) <= (A.slideFactorY || 0))) {
                                            ...
                                            q(!0), M(), R(), F(i);
                                            var u,
                                                f = { left: (u = E.getBoundingClientRect()).left + l("scrollLeft", "pageXOffset"), top: u.top + l("scrollTop", "pageYOffset") };
                                            (T = b("pageX", e) - f.left),
                                                (x = b("pageY", e) - f.top),
